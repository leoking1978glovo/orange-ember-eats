  ...
  return (
    <section id="ubicacion" className="bg-cream py-16 md:py-24">
      <div className="mx-auto max-w-[1600px] px-4 md:px-12">
        ...
        >
          <iframe
            src="https://www.google.com/maps/embed?pb=!4v1788505618914!6m8!1m7!1sGkUCzapZdVP16URGj1U0nw!2m2!1d36.84720524533584!2d-2.45420005080016!3f148.2043924976326!4f-2.1806942141146948!5f0.4000000000000002"
            width="100%"
            height="450"
            style={{ border: 0 }}
            allowFullScreen
